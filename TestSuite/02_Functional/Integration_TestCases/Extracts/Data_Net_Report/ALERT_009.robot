...
ALERT_009
    ...
    ...    2. Run after 1 calendar date. (Example: Expanded_Scenario1.robot is ran at 12/1, run this script ALERT_009 at 12/2)
    ...    @author: clanding    01DEC2020    - initial create
    
    Set Global Variable    ${TestCase_Name}    ALERT_009
    ...
    Mx Execute Template With Specific Test Case Name    Validate Alert Details for Outstandings are Correct from Alert Report    ${DNR_DATASET}    Test_Case    ${TestCase_Name}    ALERT