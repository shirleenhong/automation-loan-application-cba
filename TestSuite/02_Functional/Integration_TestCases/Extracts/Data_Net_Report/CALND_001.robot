...
CALND_001
    ...
    MX Execute Template With Specific Test Case Name    Validate The Branch, Process Area and Deal Calendar of Calendar Report    ${DNR_DATASET}    Test_Case    ${TestCase_Name}    CALND_001
