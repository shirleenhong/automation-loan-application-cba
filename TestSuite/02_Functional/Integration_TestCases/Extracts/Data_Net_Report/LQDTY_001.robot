...
LQDTY_001
    ...
    Set Global Variable    ${TestCase_Name_SummaryTab}    LQDTY_001_SummaryTab
    Set Global Variable    ${TestCase_Name_DetailsTab}    LQDTY_001_DetailsTab
    MX Execute Template With Specific Test Case Name    Validate Summary and Details from Liquidity Report    ${DNR_DATASET}    Test_Case    ${TestCase_Name_SummaryTab}    LQDTY
    MX Execute Template With Specific Test Case Name    Validate Summary and Details from Liquidity Report    ${DNR_DATASET}    Test_Case    ${TestCase_Name_DetailsTab}    LQDTY