...
SAPWUL_UPD09
    [Tags]    SAPWUL_UPD09
	[Documentation]    Verify that user is able to Delete a Borrower using Facility Change Transaction and payload is generated successfully
    ...    @author: ehugo
    ...
    ### Facility Update ###
    Mx Execute Template With Multiple Data    Delete Borrower Then Approve and Release the Facility Change Transaction    ${SAPWUL_DATASET}    ${Facility_RowID}    FacilityData
