...
PTY_015
    ...
    Mx Execute Template With Specific Test Case Name    Validate Disabled Fields in Quick Party Onboarding     ${PTY_DATASET}    Test_Case    ${TestCase_Name}    QuickPartyOnboarding