...
Establish Facility - CRED01
    ...
    Mx Execute Template With Multiple Data    Update Commitment Fee for New Life BILAT    ${CBAUAT_ExcelPath}    ${rowid}    SERV29_CommitmentFeePayment
    ...
    Mx Execute Template With Multiple Data    Release Commitment Fee for New Life Bilat    ${CBAUAT_ExcelPath}    ${rowid}    SERV29_CommitmentFeePayment
