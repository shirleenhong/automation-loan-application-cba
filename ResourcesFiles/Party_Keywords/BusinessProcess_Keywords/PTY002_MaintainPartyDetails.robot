...
Update Party Details in Maintain Party Details Module
    ...
    Run Keyword If    '${TestCase_Name}'=='PTY002_MaintainPartyDetails'    Run Keywords    Write Data To Excel    QuickPartyOnboarding    Enterprise_Name     ${TestCase_Name}    ${New_Enterprise_Name}    ${PTY_DATASET}    bTestCaseColumn=True
    ...
    ...    &{ExcelPath}[Entity]    &{ExcelPath}[Assigned_Branch]    &{ExcelPath}[Party_Type]    &{ExcelPath}[Party_Sub_Type]    &{ExcelPath}[Party_Category]    &{ExcelPath}[Party_ID]    &{ExcelPath}[Enterprise_Name]    &{ExcelPath}[Registered_Number]   
    ...    &{ExcelPath}[Country_of_Registration]    &{ExcelPath}[Country_of_Tax_Domicile]    &{ExcelPath}[Short_Name]    &{ExcelPath}[Address_Type]    &{ExcelPath}[Address_Line_1]    &{ExcelPath}[Address_Line_2]
