...
Create Party ID Successfully in Quick Party Onboarding
    ...
    ...    @update: javinzon    28OCT2020    - Added Write Data To Excel for PTY020_PartyCrossReferenceDetails
    [Arguments]    ${ExcelPath}
    ...
    Write Data To Excel    QuickPartyOnboarding    Party_ID    ${TestCase_Name}    ${Party_ID}    ${PTY_DATASET}    bTestCaseColumn=True
