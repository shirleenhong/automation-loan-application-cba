...
Create Party in Quick Party Onboarding
    ...
    ...    AND    Write Data To Excel    QuickPartyOnboarding    Enterprise_Name    PTY008_DuplicateEnterpriseName_AcrossEntities    ${Enterprise_Name}    ${PTY_DATASET}        bTestCaseColumn=True   
