...
Navigate to Customer Notebook via Customer ID
    ...
    Capture Page Screenshot    ${screenshot_path}/Screenshots/Party/PartyLIQCustomerSearchPage-{index}.png
...
Return Customer Details from Active Customer General Tab
    ...
    Capture Page Screenshot    ${screenshot_path}/Screenshots/Party/PartyLIQActiveCustomerGeneralTabPage-{index}.png
    ...
    ${GSTID}    Mx LoanIQ Get Data    ${LIQ_ActiveCustomer_Window_GSTID}    text
...
Verify If Value Exists in Loan IQ
    ...
    ...    ELSE IF    '${sFieldType}'=='Listbox'    Set List Text with 1 word to Locator    ${sLIQWindowName}    ${sFieldValue}
...
Validate Customer SIC
    ...
    Capture Page Screenshot    ${screenshot_path}/Screenshots/Party/PartyLIQActiveCustomerSICTabPage-{index}.png
...
Validate Customer Legal Address Details
    ...
    Capture Page Screenshot    ${screenshot_path}/Screenshots/Party/PartyLIQActiveCustomerLegalAddressPage-{index}.png
    ...
    Run Keyword If    '${sAddressLine3}'!='${EMPTY}' and '${sAddressLine3}'!='${None}'    Verify If Value Exists in Loan IQ    Address Line 3    ${sAddressLine3}    View Address
    Run Keyword If    '${sAddressLine4}'!='${EMPTY}' and '${sAddressLine4}'!='${None}'    Verify If Value Exists in Loan IQ    Address Line 4    ${sAddressLine4}    View Address

    Mx LoanIQ Click    ${LIQ_Active_Customer_Notebook_ViewAddressWindow_CancelButton}       
...
Validate Party Details in Loan IQ
    ...
    ...    ${sAddressCode}    ${sAddressLine1}    ${sAddressLine2}    ${sCity}    ${sCountry}    ${sCountryOfTaxDomicile}    ${sPostalCode}
    ...
    Validate Customer Legal Address Details    ${sEnterpriseName}    ${sAddressCode}    ${sAddressLine1}    ${sAddressLine2}    ${sCity}    ${sCountry}    ${sCountryOfTaxDomicile}    ${sPostalCode}
