...
Valiate Enterprise Business Activity Page
...
Verify Party Detail Enquiry Search Row Value
    ...
    ${sVerifiedRowValue}    Get Table Value Containing Row Value in Party Detail Search Dialog     ${sKeyReferenceHeader}    ${iKeyReferenceValue}      ${sHeaderName}
    
    Compare Two Strings    ${sVerifiedRowValue}    ${sRowKnownValue}
