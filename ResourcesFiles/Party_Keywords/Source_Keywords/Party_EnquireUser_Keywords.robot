...
Search User ID in Party Enquire User Page for Successful Delete
    ...
    ...    @update: cfrancis    03AUG2020    - updated object being verified for Element Should not be visible
    [Arguments]    ${sUserID}
    ...
    Click Element    ${Party_SearchUser_Search_Button}
    ${Party_SearchUser_User_Not_Found_Label_Status}    Run Keyword And Return Status    Element Should Be Visible    ${Party_SearchUser_Error_TextMessage}
    ...
    Element Should Not Be Visible    ${Party_SearchUser_Table}\[1]${Party_SearchUser_UserID_TableRow}
