...
Delete Party User in Party UI
    [Documentation]    This keyword is used to navigate to Delete User page in Party and delete user in Party based on Login Id.
    ...    This validates that user is succesfully deleted.  
    ...    @author: dahijara    19SEP2019    - initial create
    ...    @update: rtarayao    21NOV2019    - added keyword to log out user from party
    [Arguments]    ${iPartyID}

    Launch PARTY Page
    Search Process in Party    ${DELETE_USER}
    Delete User in Party Using LoginId    ${iPartyID}
