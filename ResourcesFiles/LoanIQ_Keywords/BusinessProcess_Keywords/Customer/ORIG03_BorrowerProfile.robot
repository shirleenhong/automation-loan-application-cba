...
Search Customer and Complete its Borrower Profile Creation
	...
	Run Keyword If    '${SCENARIO}'=='5'    Run Keywords    Write Data To Excel    SERV13_InterestCapitalization    Remittance_Description    ${rowid}    ${RemittanceInstruction_DDADescriptionAUD}
    ...
    Run Keyword If    '${SCENARIO}'=='6'    Run Keywords    Write Data To Excel    SERV01_47_FlexPISchedule    Borrower1_RTGSRemittanceDescription    ${rowid}    ${RemittanceInstruction_RTGSDescriptionAUD}
    ...    AND    Write Data To Excel    SERV23_LoanPaperClip    Remittance_Description    ${rowid}    ${RemittanceInstruction_RTGSDescriptionAUD}
    ...
    Run Keyword If   '${SCENARIO}'=='6'    Run Keywords    Write Data To Excel    SERV01_47_FlexPISchedule    Borrower1_ContactEmail    ${rowid}    ${Contact_Email}         
