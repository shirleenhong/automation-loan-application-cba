...
Compute SBLC Issuance Fee Amount Per Cycle
    ...
    [Arguments]    ${sCycleNumber}    ${sSystemDate}    ${sRunTimeVar_ProjectedCycleDue}=None
    ...
    ${ProjectedCycleDue}    Evaluate Issuance Fee    ${iGlobalOriginal}    ${Rate}    ${RateBasis}    ${CycleNumber}    ${SystemDate}
...
Evaluate Issuance Fee
    ...
    ...    @author: fmamaril
    ...    @update: ritragel    02SEP2019    Updated documentation
    [Arguments]    ${iGlobalOriginal}    ${Rate}    ${RateBasis}    ${CycleNumber}    ${SystemDate}
    ...
    ${DueDate}    Mx LoanIQ Store TableCell To Clipboard    ${LIQ_BankGuarantee_Accrual_JavaTree}    ${CycleNumber}%Due Date%duedate
    Log    ${StartDate}
    Log    ${DueDate}
