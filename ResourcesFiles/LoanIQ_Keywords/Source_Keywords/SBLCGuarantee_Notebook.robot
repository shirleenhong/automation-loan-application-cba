...
Evaluate Issuance Fee
    ...
    [Arguments]    ${iGlobalOriginal}    ${Rate}    ${RateBasis}    ${CycleNumber}    ${SystemDate}    ${sAccrualRule}
...
Verify Pricing Formula
    ...
    [Arguments]    ${sPricing_Formula_Lender}    ${sCycle_Frequency}    ${sAccrualRule}=None
    ...
    Run Keyword If    '${AccrualRule}'!='None'    Mx LoanIQ Select Combo Box Value    ${LIQ_SBLCGuarantee_AccrualRule_Dropdown}    ${AccrualRule}
