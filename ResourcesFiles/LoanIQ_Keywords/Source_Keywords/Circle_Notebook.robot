...
Complete Circle Fee Decisions
    [Documentation]    This keyword is Completed circle fee decision of all Facilities for New Internal Participation
    ...
    \    
    \    Populate Circle Fee Decisions    ${FacilityName} 
...
Validate Pending Participation Buy
    [Documentation]    This keyword validates details of Internal participation Buy. 
    ...    @author: mcastro    16OCT2020    -initial create
    ...
    Run Keyword And Continue On Failure    Mx LoanIQ Verify Object Exist    ${LIQ_PendingParticipationBuy_Window}    
    
    ### Validate Buy Amount ###      
    ${Actual_Buy_Amount}    Mx LoanIQ Get Data    ${LIQ_PendingParticipationSell_BuyAmount}    Value
    ...
    ${Actual_Circled_Amount}    Mx LoanIQ Get Data    ${LIQ_PendingParticipationBuy_AmtsDates_CircledAmount}    Value
