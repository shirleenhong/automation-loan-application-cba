...
Approval For Internal Participation Buy
    ...
    [Arguments]    ${sDeal_Name}    ${sBuyer_LegalEntity}
    ...
    Mx LoanIQ DoubleClick    ${LIQ_WorkInProgress_TransactionDetails_List}    Awaiting Complete Portfolio Allocations    #To be finalized
    ...
    Mx LoanIQ DoubleClick    ${LIQ_WorkInProgress_TransactionDetails_List}    ${Deal_Name}${SPACE}${SPACE}${Buyer_LegalEntity}${SPACE}SELL${SPACE}50,000,000.00
    ...
    Take Screenshot    ${Screenshot_Path}/Screenshots/LoanIQ/ParticipationSellWindow_WorkflowTab
    Mx LoanIQ Select Or DoubleClick In Javatree    ${LIQ_AwatingApprovalParticipation_Workflow_JavaTree}    Approval%d
    Mx LoanIQ Click Element If Present    ${LIQ_Warning_Yes_Button}
    Mx LoanIQ Click Element If Present    ${LIQ_Question_Yes_Button}
    Mx LoanIQ Click    ${LIQ_AwatingApprovalParticipation_OKButton}
    Run Keyword And Continue On Failure    Mx LoanIQ Verify Object Exist    ${LIQ_OpenPartipication_JavaWindow}    VerificationData="Yes"  
...
Approval For Internal Participation Sell
    ...
    ...    @author: mcastro    19OCT2020    -initial created
    [Arguments]    ${sDeal_Name}    ${sSeller_LegalEntity}
     ### Keyword Pre-processing ###
    ${Deal_Name}    Acquire Argument Value    ${sDeal_Name}
    ...
    Mx LoanIQ Maximize    ${LIQ_TransactionsInProcess_Window}
    Mx LoanIQ DoubleClick    ${LIQ_TransactionsInProcess_Transactions_List}    Circles
    Mx LoanIQ DoubleClick    ${LIQ_WorkInProgress_TransactionDetails_List}    Awaiting Complete Portfolio Allocations
    Mx LoanIQ DoubleClick    ${LIQ_WorkInProgress_TransactionDetails_List}    Host Bank
    Mx LoanIQ DoubleClick    ${LIQ_WorkInProgress_TransactionDetails_List}    Participation  
    Mx LoanIQ DoubleClick    ${LIQ_WorkInProgress_TransactionDetails_List}    ${Deal_Name}${SPACE}${SPACE}${Seller_LegalEntity}${SPACE}BUY${SPACE}50,000,000.00
    # Mx LoanIQ DoubleClick    ${LIQ_WorkInProgress_TransactionDetails_List}    ${Deal_Name}
