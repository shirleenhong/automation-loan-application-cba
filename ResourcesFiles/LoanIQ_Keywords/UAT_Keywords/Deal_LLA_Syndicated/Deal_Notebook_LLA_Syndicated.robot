...
Setup Syndicated Deal for LLA Syndicated
    ...
    Write Data To Excel    Correspondence    Deal_Name    1    ${Deal_Name}    bTestCaseColumn=True    sColumnReference=rowid
    Write Data To Excel    Correspondence    Deal_Name    2    ${Deal_Name}    bTestCaseColumn=True    sColumnReference=rowid
