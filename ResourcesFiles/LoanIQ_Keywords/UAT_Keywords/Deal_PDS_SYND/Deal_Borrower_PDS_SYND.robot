...
Create Deal Borrower Initial Details in Quick Party Onboarding for PDS Syndicate Deal
    [Documentation]    This keyword creates a Deal Borrower in Quick Party Onboarding for CH EDU Bilateral Deal.
    ...    @author:    shirhong    04JAN2021    Initial Create
    [Arguments]    ${ExcelPath}
...
Search Customer and Complete Borrower Profile Creation with Default Values for PDS Syndicate Deal
