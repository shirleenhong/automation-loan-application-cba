...
Get Future Date Record in Holding Table for TL FXRates
    ...
    ...    @update: ccarriedo   04NOV2020    - added ${sSUB_ENTITY_NAME} as Argument which will be used for ${MASTER_MAPPING_TABLE}.${SUB_ENTITY_NAME}
    [Arguments]    ${sFilename}    ${sTransformedData_FilePath}    ${sSUB_ENTITY_NAME}    
    ...
    ...    ${WHERE_Q}    ${FILE_NAME_QUERY}    IN    ('${sFilename}_0','${sFilename}_1')    AND    ${MASTER_MAPPING_TABLE}.${SUB_ENTITY_NAME}    =    '${sSUB_ENTITY_NAME}'
