...
Setup Primaries for Syndicated Deal for DNR
    ...
    Write Data To Excel    SC2_FacilityShareAdjustment    HostBank_ShareAmount    ${rowid}   ${HostBank_ShareAmount}    ${DNR_DATASET}
    Write Data To Excel    SC2_FacilityShareAdjustment    Lender_ShareAmount1    ${rowid}    ${Lender_ShareAmount1}    ${DNR_DATASET}
    Write Data To Excel    SC2_FacilityShareAdjustment    Lender_ShareAmount2    ${rowid}    ${Lender_ShareAmount2}    ${DNR_DATASET}
