...
Setup Deal Administrative Fees for DNR
    ...
    Write Data To Excel    SC2_AdminFee    AdminFee_EffectiveDate    ${rowid}    ${AdminFee_EffectiveDate}    sFilePath=${DNR_DATASET}
    Write Data To Excel    SC2_AdminFeePayment    AdminFeePayment_EffectiveDate    ${rowid}    ${AdminFee_EffectiveDate}    sFilePath=${DNR_DATASET}
    ...
    Write Data To Excel    SC2_AdminFee    AdminFee_Alias    ${rowid}    ${AdminFee_Alias}    sFilePath=${DNR_DATASET}
    Write Data To Excel    SC2_AdminFeePayment    AdminFee_Alias    ${rowid}    ${AdminFee_Alias}    sFilePath=${DNR_DATASET}
    Write Data To Excel    SC2_AdminFeePayment    AdminFee_DueDate    ${rowid}    ${AdminFee_DueDate}    sFilePath=${DNR_DATASET}
    ...
    ${AdminFee_Alias}    Read Data From Excel    SC2_AdminFee    AdminFee_Alias    &{ExcelPath}[rowid]    sFilePath=${DNR_DATASET}
