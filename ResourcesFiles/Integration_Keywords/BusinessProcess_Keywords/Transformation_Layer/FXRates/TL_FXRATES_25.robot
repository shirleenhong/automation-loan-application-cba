...
Send FXRates GS Group 2 File and Verify Triangulation
    [Documentation]    Used to send Group 2 Golden Source file to SFTP site. Then validate if GS file is processed and moved to Archive folder.
