...
*** Keywords ***
Send GSFile for FX Rates with Missing Mandatory Header
    [Documentation]    Used to send Golden Source file with missing mandatory header
    ...
    ...    @author: dahijara    17FEB2020    - initial create
    [Arguments]    ${ExcelPath}
    ...
    Run Keyword And Continue On Failure    Validate FFC for TL FXRates Failed    &{ExcelPath}[OutputFilePath]    &{ExcelPath}[OutputFFCResponse]    ${FXRATES_MISSINGHEADER}
