...
*** Keywords ***
Send FXRates GS Group 1 File with Empty Rows
    [Documentation]    Used to send Group 1 Golden Source file that contains empty rows to SFTP site. Then validate if GS file is processed and moved to Archive folder.
