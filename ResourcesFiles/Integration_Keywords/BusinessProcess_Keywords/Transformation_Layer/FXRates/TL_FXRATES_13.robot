...
*** Keywords ***
Send GSFile for FX Rates with XLSX File Type
    [Documentation]    Used to send Golden Source file with XLSX file type.
    ...
    Run Keyword And Continue On Failure    Validate File If Moved to File Validation Failed Folder    ${TL_FXERR_FILEVAL_FOLDER}    &{ExcelPath}[InputGSFile]    ${XLSX}    ${INVALIDFILEFORMAT}
