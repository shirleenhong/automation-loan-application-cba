...
*** Keywords ***
Send GSFile for FX Rates with Invalid Small Cases Name
    [Documentation]    Used to send Golden Source file with invalid  Small Cases in File name.
    ...
    Run Keyword And Continue On Failure    Validate File If Moved to File Validation Failed Folder    ${TL_FXERR_FILEVAL_FOLDER}    &{ExcelPath}[InputGSFile]    ${CSV}    ${SMALLCASESFILENAME}
