...
*** Keywords ***
Send GSFile for FX Rates with Empty Field Value
    [Documentation]    Used to send Golden Source file with empty field value.
    ...
    Run Keyword And Continue On Failure    Validate FFC for TL FXRates Failed    &{ExcelPath}[OutputFilePath]    &{ExcelPath}[OutputFFCResponse]    ${MANDATORYVALUEMISSING_DESC}
