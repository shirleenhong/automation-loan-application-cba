...
*** Keywords ***
Send GSFile for FX Rates with TXT File Type
    [Documentation]    Used to send Golden Source file with TXT file type.
    ...
    ...    @author: dahijara    4FEB2020    - initial create
    [Arguments]    ${ExcelPath}
    ...
    Run Keyword And Continue On Failure    Validate File If Moved to File Validation Failed Folder    ${TL_FXERR_FILEVAL_FOLDER}    &{ExcelPath}[InputGSFile]    ${TXT}    ${INVALIDFILEFORMAT}
