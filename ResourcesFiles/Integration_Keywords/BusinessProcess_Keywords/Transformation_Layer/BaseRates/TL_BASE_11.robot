...
Send GS Group 3 File
    [Documentation]    Used to send a valid Group 3 Golden Source file to SFTP site, validate if GS file is processed and moved to Archive folder,
    ...
    ...    @update: mcastro     06OCT2020    - added missing argument variable for Create expected TextJMS XML
