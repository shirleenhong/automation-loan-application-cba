...
Send GS Group 2 File
    [Documentation]    Used to send a valid Group 2 Golden Source file to SFTP site, validate if GS file is processed and moved to Archive folder,
