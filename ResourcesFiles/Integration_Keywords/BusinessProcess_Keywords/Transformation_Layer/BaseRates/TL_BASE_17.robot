...
Send Golden Source File with Non-Existing Base Rate Code and Price Type Config
    [Documentation]    Used to send Golden Source file with Non-Existing Base Rate Code and Price Type Config. 
