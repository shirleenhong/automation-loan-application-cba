...
Send Golden Source File with Small Cases File Name
    [Documentation]    Used to send Golden Source file with invalid file name to SFTP site. 
    ...
    Run Keyword And Continue On Failure    Validate File If Moved to File Validation Failed Folder    ${TL_BASEERR_FILEVAL_FOLDER}    &{ExcelPath}[InputGSFile]    ${CSV}    ${SMALLCASESFILENAME}
