...
Send GS Group 6 File
    [Documentation]    Used to send a valid Group 6 Golden Source file to SFTP site, validate if GS file is processed and moved to Archive folder,
    ...
    ...    @update: jdelacru    02OCT2020    - changed the location of templates items for Base Rate by adding variable TemplateFilePath
    [Arguments]    ${ExcelPath}
