...
Send Golden Source File with Invalid Group Name
    [Documentation]    Used to send Golden Source file with invalid file name (invalid Group name) value to SFTP site. 
