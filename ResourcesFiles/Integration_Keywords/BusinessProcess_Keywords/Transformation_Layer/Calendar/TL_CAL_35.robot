...
Send Copp Clark Files with Inactive Calendar ID
    [Documentation]    Used to send a Copp Clark Files that with an inactive calendar ID. Then validate if Copp Clark files are not processed and moved to Archive folder.
