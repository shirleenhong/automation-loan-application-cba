...
Send Copp Clark Files with Invalid File Name for XLS Misc File 
    [Documentation]    Used to send an invalid Copp Clark xls misc file to SFTP site. Then validate if Copp Clark files are processed and moved to Error folder.
    ...
    Get File Name From Error List    ${ARCHIVE_GSFILENAME_LIST}    ${Misc_File}
