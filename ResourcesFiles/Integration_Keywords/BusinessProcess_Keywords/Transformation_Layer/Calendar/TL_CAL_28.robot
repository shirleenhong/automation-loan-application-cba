...
Send Copp Clark Files Misc with Missing Mandatory Field
    [Documentation]    This keyword is used to send valid Copp Clark files to SFTP site with missing mandatory field XLS File Misc.
