...
Send Copp Clark Files with Multiple Rows and Same Date
    [Documentation]    This keyword is used to send copp clark files with the multiple rows having the same dates
    ...    But different Event Name and Verify that only the 1st record will be processed successfullyin LIQ to SFTP site.
