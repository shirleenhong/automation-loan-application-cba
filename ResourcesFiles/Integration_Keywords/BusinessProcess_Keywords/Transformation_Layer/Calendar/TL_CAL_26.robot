...
Send Copp Clark Files 1 with Missing Mandatory Field
    [Documentation]    This keyword is used to send valid Copp Clark files to SFTP site with missing mandatory field XLS File 1.
    ...
    ...    @author: dahijara    08JAN2019    - initial create
    [Arguments]    ${ExcelPath}
    ...
    ${ExpectedResponseDesc}    Set Variable    ${MISSING_FIELD_FILE_1_2_VAL_RESPONSE}${SPACE}${FILE1_ARCHIVE_NAME}${SPACE}${OR_FILE_FORMAT_IS_WRONG}
