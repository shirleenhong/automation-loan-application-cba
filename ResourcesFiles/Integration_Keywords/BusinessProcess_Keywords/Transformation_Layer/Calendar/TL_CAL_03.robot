...
Send Copp Clark Files with Invalid File Name for XLS File 2
    [Documentation]    Used to send an invalid Copp Clark xls file 2 to SFTP site. Then validate if Copp Clark files are processed and moved to Error folder.
    ...
    Get File Name From Error List    ${ARCHIVE_GSFILENAME_LIST}    ${File_2}
