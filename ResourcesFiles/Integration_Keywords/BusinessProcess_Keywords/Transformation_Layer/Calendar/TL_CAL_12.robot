...
Send Copp Clark Files with Missing Headers
    [Documentation]    This keyword is used to send valid Copp Clark files to SFTP site with missing headers in XLS Files.
    ...
    ...    @author: dahijara    29JAN2019    - initial create
    [Arguments]    ${ExcelPath}
    ...
    ${ExpectedResponseDesc}    Set Variable    ${ROW_2}${SPACE}${CENTRECODE}${EMPTY_IN_FILE}${SPACE}${FILE1_ARCHIVE_NAME}${||}
