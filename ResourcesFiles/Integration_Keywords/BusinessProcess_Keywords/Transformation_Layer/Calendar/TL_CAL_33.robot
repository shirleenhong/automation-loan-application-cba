...
Send Copp Clark File Misc with Duplicate Headers
    [Documentation]    This keyword is used to send valid Copp Clark files to SFTP site with duplicate headers in XLS File Misc.
    ...
    ...    @author: dahijara    24JAN2019    - initial create
    [Arguments]    ${ExcelPath}
