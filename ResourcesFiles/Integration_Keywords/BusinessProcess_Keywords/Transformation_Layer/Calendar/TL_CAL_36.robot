...
Send Copp Clark Files with Inactive Holiday Date
    [Documentation]    This keyword is used to send copp clark files with inactive holiday date/s in LIQ to SFTP site.
