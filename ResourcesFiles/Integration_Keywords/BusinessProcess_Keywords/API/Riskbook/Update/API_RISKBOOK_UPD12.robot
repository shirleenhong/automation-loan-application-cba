...
Update ViewPriceIndicator Using Login ID
    [Documentation]    This keyword is used to validate that user is able to Update RiskBook ViewPrice Indicator for a User using Login Id
