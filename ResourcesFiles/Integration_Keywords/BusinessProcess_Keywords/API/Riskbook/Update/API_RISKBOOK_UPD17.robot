...
Update Riskbook Using User Id and Verify Response Status 404
    [Documentation]    This keyword is used to update Riskbook for an Invalid User Id
    ...
    Run Keyword And Continue On Failure    PUT Request for Risk Book API and Verify Response Status Code 404    &{APIDataSet}[InputFilePath]    &{APIDataSet}[InputJson]    &{APIDataSet}[OutputFilePath]    &{APIDataSet}[OutputAPIResponse]    sUserId=&{APIDataSet}[userId]