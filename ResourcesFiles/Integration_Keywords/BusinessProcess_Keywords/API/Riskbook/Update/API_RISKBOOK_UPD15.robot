...
Update Riskbook for an Invalid Riskbook Code Using User Id and Verify Response Status
    ...
    Run Keyword And Continue On Failure    PUT Request for Risk Book API and Verify Response Status Code 400    &{APIDataSet}[InputFilePath]    &{APIDataSet}[InputJson]    &{APIDataSet}[OutputFilePath]    &{APIDataSet}[OutputAPIResponse]    sUserId=&{APIDataSet}[userId]