...
Update Riskbook with an Empty Payload Using User Id and Verify Response Status 400
    [Documentation]    This keyword is used to update Riskbook with an Empty Array using User Id
