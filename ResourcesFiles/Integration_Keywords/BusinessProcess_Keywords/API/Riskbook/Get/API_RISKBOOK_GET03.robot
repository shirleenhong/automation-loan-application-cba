...
Get RiskBook for a Single RiskBook Added via UI for Valid User Id
    [Documentation]    This keyword is used to get RiskBook for a single RiskBook added via UI for Valid User Id
    ...    and validates if there are no Risk Book Access in LoanIQ
    ...    @author: xmiranda    06SEP2019    - initial draft
