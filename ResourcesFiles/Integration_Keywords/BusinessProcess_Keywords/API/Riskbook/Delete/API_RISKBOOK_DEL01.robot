...
Delete Single Risk Book Using User Id
    [Documentation]    This keyword is used to validate that user is able to delete single risk book using user Id and response is 200
