...
Delete All Risk Books Using User Id
    [Documentation]    This keyword is used to validate that user is able to delete all risk books using user Id and response is 200
    ...
    Run Keyword And Continue On Failure    Validate Risk Book Details to an Existing User in LoanIQ for Delete All Risk Books    &{APIDataSet}[userId]    &{APIDataSet}[riskBookCode]    &{APIDataSet}[OutputFilePath]
