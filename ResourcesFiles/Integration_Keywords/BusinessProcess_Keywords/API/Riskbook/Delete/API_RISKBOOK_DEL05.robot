...
Delete Multiple Risk Books Using Login Id
    [Documentation]    This keyword is used to validate that user is able to delete multiple risk book using login Id and response is 200
