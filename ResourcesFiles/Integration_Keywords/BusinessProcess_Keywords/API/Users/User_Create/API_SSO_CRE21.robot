...
*** Keywords ***
Create LIQ User Using Maximum Field Lengths and No Error in CCB
    ...
    ...    And validate that the user is not created in LIQ.
...
Create Essence User Using Maximum Field Lengths and No Error in CCB
    [Documentation]    This keyword is used to create prerequisites for execution.
    ...    And send a POST request for an Essence user using maximum field lengths.
    ...    And validate that the user is not created in Essence.
    ...    @author: dahijara   31JUL2019    - Initial create
    ...    @update: dahijara    8AUG2019    - Updated keyword for AD error validation
    [Arguments]    ${APIDataSet}
...
Create Party User Using Maximum Field Lengths and No Error in CCB
    [Documentation]    This keyword is used to create prerequisites for execution.
    ...    And send a POST request for a Party user using maximum field lengths.
    ...    And validate that the user is not created in Party.
    ...    @author: dahijara   31JUL2019    - Initial create
    ...    @update: dahijara    8AUG2019    - Updated keyword for AD error validation
    [Arguments]    ${APIDataSet}
