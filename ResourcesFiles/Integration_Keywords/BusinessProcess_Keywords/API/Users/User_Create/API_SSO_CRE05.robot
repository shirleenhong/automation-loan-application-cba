...
Create User for Multiple LOB
    ...
    ...    @author: clanding
    ...    @update: clanding    15APR2019    - refactor according to CBA Evergreen Automation Checklist and PointSheet v1.0.1
    ...    @update: clanding    22APR2019    - update documentation, added validation for Essence and Party, changed keyword for LoanIQ Validation
    ...    @update: clanding    15MAY2019    - added database look up for Branch value
    ...    @update: jdelacru    06NOV2019    - updated argument for title config for essence
