...
*** Keywords ***
Create User for LIQ with Valid Minimum Fields
    [Documentation]    This keyword is used to create prerequisites for execution.
    ...    And send a POST request for LIQ user using valid minimum field lengths. And validate MCH UI for AD, SSO and LIQ.
    ...    Then validate success creation in MCH UI for AD, SSO and LIQ.
    ...    Then validate success creation in SSO Page and in LIQ.
    ...    @author: dahijara    06AUG2019    - Initial create.
...
Create User for Essence with Valid Minimum Fields
    [Documentation]    This keyword is used to create prerequisites for execution.
    ...    And send a POST request for LIQ user using valid minimum field lengths. And validate MCH UI for AD, SSO and Essence.
    ...    Then validate success creation in MCH UI for AD, SSO and Essence.
    ...    Then validate success creation in SSO Page and in Essence.
    ...    @author: dahijara    06AUG2019    - Initial create
    [Arguments]    ${APIDataSet}
...
Create User for Party with Valid Minimum Fields
    [Documentation]    This keyword is used to create prerequisites for execution.
    ...    And send a POST request for LIQ user using valid minimum field lengths. And validate MCH UI for AD, SSO and Party.
    ...    Then validate success creation in MCH UI for AD, SSO and Party.
    ...    Then validate success creation in SSO Page and in Party.
    ...    @author: dahijara    06AUG2019    - Initial create
    [Arguments]    ${APIDataSet}
