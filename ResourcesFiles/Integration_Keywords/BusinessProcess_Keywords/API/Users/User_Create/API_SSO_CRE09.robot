...
Create User for Single LOB with INACTIVE Status and UNLOCKED
    [Documentation]    This keyword is used to create user with single LOB and INACTIVE status and UNLOCKED.
    ...    @author: clanding
    ...    @update: clanding    15APR2019    - refactor according to CBA Evergreen Automation Checklist and PointSheet v1.0.1
    ...    @update: clanding    22APR2019    - changed LoanIQ Validation keyword
    ...    @update: clanding    29APR2019    - removed getting of job function code in the config, as per Allan for CBA config
