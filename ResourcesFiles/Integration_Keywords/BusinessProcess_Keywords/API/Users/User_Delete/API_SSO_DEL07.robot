...
Delete User on Single LOB for Party
    [Documentation]    This keyword is used to delete user with single lob for Party
    ...    and validate successful delete in FFC, SSO and Party
