...
Delete User on Loan IQ and Essence LOBs
    ...
    ...    @update: jdelacru    26NOV2019    - added InputJson as argument for FFC validation
...
Delete User on Loan IQ and Party LOBs
    [Documentation]    This keyword is used to delete user on Loan IQ and Party Lobs
    ...    and validate successful delete in FFC, SSO, and on all lobs (Loan IQ, Essence and Party)
    ...    @author: amansuet	27AUG2019	- initial create
    ...    @update: jdelacru    26NOV2019    - added InputJson as argument for FFC validation
    [Arguments]    ${APIDataSet}
...
Delete User on Essence and Party LOBs
    [Documentation]    This keyword is used to delete user on Essence and Party Lobs
    ...    and validate successful delete in FFC, SSO, and on all lobs (Loan IQ, Essence and Party)
    ...    @author: amansuet	23AUG2019    - initial create
    ...    @update: amansuet    27AUG2019    - keyword name change
    ...    @update: jdelacru    26NOV2019    - added InputJson as argument for FFC validation
    [Arguments]    ${APIDataSet}
