...
*** Keywords ***
Update Existing User from Active to Inactive
    [Documentation]    This keyword is used to create prerequisites for execution.
    ...    And send a PUT request for existing LIQ user, update status from Active to Inactive. And validate MCH UI for AD, SSO and LIQ.
