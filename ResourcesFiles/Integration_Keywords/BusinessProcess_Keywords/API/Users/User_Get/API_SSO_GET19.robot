...
*** Keywords ***
Get User with Single LOB from Updated Secondary Processing
    ...
    Run Keyword And Continue On Failure    Validate Updated Fields via LOB UI using GET Single API    &{APIDataSet}[additionalProcessingArea]    additionalProcessingArea
