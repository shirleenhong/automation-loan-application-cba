...
Create User with Invalid Business Entity Name
    [Documentation]    This keyword is used to create a user with invalid business entity name.
    ...    @author: cfrancis    07AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
    
    ${BusinessEntityList}    Split String    &{APIDataSet}[defaultBusinessEntity]    |
    ${BusinessEntity}    Get From List    ${BusinessEntityList}    0
    ${ErrorList}    Create List     ${400_BUSINESS_ENTITY_INVALID} {'${BusinessEntity}'} ${400_INVALID}
...
Update User with Invalid Business Entity Name
    [Documentation]    This keyword is used to validate User for invalid business entity name.
    ...    @author: cfrancis    07AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
