...
*** Keywords ***
Create User with Invalid Additional Proc Area
    [Documentation]    This keyword is used to create a user with invalid Additional processing area.
    ...    @author: cfrancis    11AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
    
    ${ErrorList}    Create List     ${400_PROC_AREA_INVALID} {'&{APIDataSet}[additionalProcessingArea]'} ${400_INVALID}
...
Update User with Invalid Additional Proc Area
    [Documentation]    This keyword is used to update a user with invalid Additional processing area.
    ...    @author: cfrancis    11AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
