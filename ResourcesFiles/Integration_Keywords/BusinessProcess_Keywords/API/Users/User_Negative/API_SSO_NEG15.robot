...
Create User Invalid Locale
    ...
    ${ErrorList}    Create List     ${400_LOCALE_INVALID} {'&{APIDataSet}[locale]'} ${400_INVALID}
...
Update User with Invalid Locale
    [Documentation]    This keyword is used to update a user with invalid locale
    ...    @author: cfrancis    06AUG2020    - refactored codes
    [Arguments]    ${APIDataSet}
