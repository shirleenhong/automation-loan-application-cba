...
*** Keywords ***
CREATE User with Null Mandatory Fields
    [Documentation]    This keyword is used to create a user with invalid input for mandatory null or no tag field length
    ...    @author:    jloretiz    12DEC2019    - initial create
    ...    @author:    jloretiz    14JAN2020    - renamed the keyword to a more generic name
    [Arguments]    ${APIDataSet}

    ###PRE-REQUISITES###
    ${ErrorList}    Create List     ${400_FNAME_FIELD_LENGTH_MISMATCH}    ${400_LNAME_FIELD_LENGTH_MISMATCH}    ${400_LOGINID_FIELD_LENGTH_MISMATCH}    
    ...    ${400_JOBTITLE_FIELD_LENGTH_MISMATCH}    ${400_COUNTRY_FIELD_LENGTH_MISMATCH}
...
UPDATE User with Null Mandatory Fields
    [Documentation]    This keyword is used to update a user with invalid input for mandatory null or no tag field length
    ...    @author:    jloretiz    12DEC2019    - initial create
    ...    @author:    jloretiz    14JAN2020    - renamed the keyword to a more generic name
    [Arguments]    ${APIDataSet}

    ###PRE-REQUISITES###
    ${ErrorList}    Create List     ${400_FNAME_FIELD_LENGTH_MISMATCH}    ${400_LNAME_FIELD_LENGTH_MISMATCH}    ${400_JOBTITLE_FIELD_LENGTH_MISMATCH}    ${400_COUNTRY_FIELD_LENGTH_MISMATCH}
