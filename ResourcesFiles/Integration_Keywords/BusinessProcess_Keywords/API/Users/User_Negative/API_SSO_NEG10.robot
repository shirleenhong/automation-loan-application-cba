...
Create User with Invalid Default Branch
    [Documentation]    This keyword is used to create a user with invalid default branch.
    ...    @author: cfrancis    06AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
    
    ${DefBranchList}    Split String    &{APIDataSet}[defaultBusinessEntity]    |
    ${DefaultBranch}    Get From List    ${DefBranchList}    1
    ${ErrorList}    Create List     ${400_BRANCH_INVALID} {'${DefaultBranch}'} ${400_INVALID}
...
Update User with Invalid Default Branch
    [Documentation]    This keyword is used to validate User for invalid default branch.
    ...    @author: cfrancis    06AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
