...
Create User with Invalid Primary Dept Code
    ...
    ${ErrorList}    Create List     ${400_DEPT_CODE_INVALID} {'&{APIDataSet}[primaryDepartment]'} ${400_INVALID}
...
Update User with Invalid Primary Dept Code
    [Documentation]    This keyword is used to update a user with invalid primary department code.
    ...    @author: cfrancis    07AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
