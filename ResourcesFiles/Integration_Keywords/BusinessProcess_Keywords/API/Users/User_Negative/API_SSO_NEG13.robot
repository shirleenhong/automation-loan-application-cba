...
*** Keywords ***
Create User with Invalid Central User Type
    [Documentation]    This keyword is used to create a user with invalid central user type.
    ...    @author: cfrancis    07AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
    
    ${ErrorList}    Create List     ${400_CENTRAL_USER_TYPE_INVALID} {'&{APIDataSet}[centralUserType]'} ${400_INVALID}
...
Update User with Invalid Central User Type
    [Documentation]    This keyword is used to validate User for invalid central user type.
    ...    @author: cfrancis    07AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
