...
*** Keywords ***
Create User with Invalid Location
    [Documentation]    This keyword is used to create a user with invalid location.
    ...    @author: cfrancis    07AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
    
    ${ErrorList}    Create List     ${400_LOCATION_INVALID} {'&{APIDataSet}[location]'} ${400_INVALID}
...
Update User with Invalid Location
    [Documentation]    This keyword is used to validate User for invalid location.
    ...    @author: cfrancis    07AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
