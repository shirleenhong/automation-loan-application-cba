...
Create User with Invalid Additional Dept Code
    [Documentation]    This keyword is used to create a user with invalid additional department code.
    ...    @author: cfrancis    10AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
    
    ${ErrorList}    Create List     ${400_DEPT_CODE_INVALID} {'&{APIDataSet}[additionalDepartments]'} ${400_INVALID}
...
Update User with Invalid Additional Dept Code
    [Documentation]    This keyword is used to update a user with invalid additional department code.
    ...    @author: cfrancis    10AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
