...
Create User with Invalid Role
    [Documentation]    This keyword is used to create a user with invalid central role
    ...    @author: cfrancis    06AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
    
    ${ErrorList}    Create List     ${400_ROLE_INVALID} {'&{APIDataSet}[centralRoles]'} ${400_INVALID}
...
Update User with Invalid Role
    [Documentation]    This keyword is used to update a user with invalid central role
    ...    @author: cfrancis    06AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
