...
*** Keywords ***
Create User with Invalid Default Proc Area
    [Documentation]    This keyword is used to create a user with invalid default processing area.
    ...    @author: cfrancis    10AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
    
    ${ErrorList}    Create List     ${400_PROC_AREA_INVALID} {'&{APIDataSet}[defaultProcessingArea]'} ${400_INVALID}
...
Update User with Invalid Default Proc Area
    [Documentation]    This keyword is used to update a user with invalid default processing area.
    ...    @author: cfrancis    10AUG2020    - refactored based from existing codes for negative scenarios
    [Arguments]    ${APIDataSet}
