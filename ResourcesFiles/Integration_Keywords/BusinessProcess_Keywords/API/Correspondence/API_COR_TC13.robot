...
*** Keywords ***
Send a Callback with Null Message ID
    [Documentation]    This keyword is use to send a callback when mandatory MessageID field is null
    ...    @author:chanario
    ...    @update: jaquitan 20Mar2019    updated keywords name, global variables
