...
*** Keywords ***
Send a Callback with Status of more than 8 characters
    [Documentation]    This keyword is use to send a callback when Status in payload contains more than 8 characters
