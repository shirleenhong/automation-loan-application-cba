...
*** Keywords ***
Send a Callback with missing Status only
    [Documentation]    This keyword is use to ensure that error is encountered for Callback when only Status is missing
