...
*** Keywords ***
NO error for SENT CALL BACK when MESSAGE is missing
    [Documentation]    This keyword is use to successfully sent out a FEE PAYMENT NOTICE via WIP with NO error when MESSAGE is missing - API_COR_TC06
    ...    @author:mgaling
