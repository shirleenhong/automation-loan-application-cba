...
*** Keywords ***
Send Successful Notice with Error Message
    [Documentation]    This keyword is use to successfully send out a NOTICE even if there is an error message - API_COR_TC23
    ...    @author:cfrancis
    ...
    ...    @update: ehugo    06SEP2019    added retrieving of Notice Details via Loan Notebook in LIQ
    ...
    ${CurrentDate}    ${FieldValue}    Validate Notice in Business Event Output Window in LIQ    ${rowid}    &{APIDataSet}[Customer_IdentifiedBy]    ${NoticeCustomerLegalName}    ${NoticeIdentifier}
    ...
    ${Correlation_ID}    Read Data From Excel for API_Data    Correspondence    Correlation_ID    ${rowid}
    ...
    ###Step 11: FFC Validation FFC1CMUpdateSourceMQ### 
    ...
    ###Step 12: Exception Queue Validation###
    ${ExpectedDescription}    Read Data From Excel for API_Data    Correspondence    WIP_ExceptionQueueDescription    ${rowid}
    ${DealName}    Read Data From Excel for API_Data    Correspondence    Deal_Name    ${rowid}
    ${NoticeID}    Read Data From Excel for API_Data    Correspondence    Notice_Identifier    ${rowid}
    Validate WIP Exception Queue Negative    ${ExpectedDescription}    ${DealName}    ${NoticeID}           
