...
Get and Validate API Outstanding Response
    ...
    Get Risk Type and Validate Response Per Risk Type    &{ComSeeDataSet}[OutputFilePath]    &{ComSeeDataSet}[ResponseJson]_OUT     &{ComSeeDataSet}[Version]    &{ComSeeDataSet}[Outstanding_Alias]    &{ComSeeDataSet}[Outstanding_RiskType]    
...
Get and Validate API Fee Response
    ...
    ...    &{ComSeeDataSet}[Fee_Status]    &{ComSeeDataSet}[Fee_AccruedToDate]    &{ComSeeDataSet}[Fee_CycleDue]    &{ComSeeDataSet}[Fee_PaidToDate]    &{ComSeeDataSet}[Fee_DueDate]    &{ComSeeDataSet}[AccrualRule_PayInAdvance]
    ...    &{ComSeeDataSet}[Fee_CycleStartDate]    &{ComSeeDataSet}[Fee_AccrualEndDate]    ,    
    
Get Response for Deal Single Facility - Scenario2
    [Documentation]    This keyword is used to GET Response for Syndicated Deal. 
    ...    This test case validates that the Get Response Payload is the same as the details seen in LIQ.
    ...    @author: rtarayao    16AUG2019    Duplicate this high level to be specific on Comsee Scenario 2.
    [Arguments]    ${ExcelPath}  
    
   ###PRE-REQUISITE - READ FACILITY DATA
   ${CurrentDate}    Get Current Date of Local Machine
   Write Data To Excel    ComSee_SC2_Deal    DateExtracted    ${rowid}    ${CurrentDate}    ${ComSeeDataSet}
   ${ExtractDate}    Read Data From Excel    ComSee_SC2_Deal    DateExtracted    ${rowid}    ${ComSeeDataSet}
   
   ${Facility_ControlNumber}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_ControlNumber    ${rowid}    ${ComSeeDataSet}    
   ${Facility_EffectiveDate}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_EffectiveDate    ${rowid}    ${ComSeeDataSet}
   ${Facility_FinalMaturityDate}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_FinalMaturityDate    ${rowid}    ${ComSeeDataSet}
   ${Facility_Currency}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_Currency    ${rowid}    ${ComSeeDataSet}
   ${Facility_MultiCCY}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_MultiCCY    ${rowid}    ${ComSeeDataSet}
   ${Facility_MultiCCY}    Convert To Boolean    ${Facility_MultiCCY}
   ${Facility_MultiCCY}    Convert To String    ${Facility_MultiCCY}
   ${Facility_Type}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_Type    ${rowid}    ${ComSeeDataSet}
   ${Facility_HostBankNetCommitment}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_HostBankNetCommitment    ${rowid}    ${ComSeeDataSet}
   ${Facility_HostBankNetOutstandings}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_HostBankNetOutstandings    ${rowid}    ${ComSeeDataSet}
   ${Facility_HostBankNetAvailableToDraw}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_HostBankNetAvailableToDraw    ${rowid}    ${ComSeeDataSet}
   ${Facility_ExpenseCode}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_ExpenseCode    ${rowid}    ${ComSeeDataSet}
   ${Facility_Processing_Code}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_Processing_Code    ${rowid}    ${ComSeeDataSet}
   ${Facility_Processing_Desc}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_Processing_Desc    ${rowid}    ${ComSeeDataSet}
   ${Facility_NoOfLenders}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_NoOfLenders    ${rowid}    ${ComSeeDataSet}
   ${Facility_NoOfBorrowers}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_NoOfBorrowers    ${rowid}    ${ComSeeDataSet}
   ${Facility_NoOfOutstanding}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_NoOfOutstanding    ${rowid}    ${ComSeeDataSet}
   ${Facility_HostBankFundableCommitment}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_HostBankFundableCommitment    ${rowid}    ${ComSeeDataSet}
   ${Facility_GlobalClosingCommitment}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_GlobalClosingCommitment    ${rowid}    ${ComSeeDataSet}
   ${Facility_GlobalCurrentCommitment}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_GlobalCurrentCommitment    ${rowid}    ${ComSeeDataSet}
   ${Facility_GlobalOutstandings}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_GlobalOutstandings    ${rowid}    ${ComSeeDataSet}
   ${Facility_GlobalAvailableToDraw}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_GlobalAvailableToDraw    ${rowid}    ${ComSeeDataSet}
   ${Facility_PortfolioCode}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_PortfolioCode    ${rowid}    ${ComSeeDataSet}
   ${Facility_PortfolioDescription}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_PortfolioDescription    ${rowid}    ${ComSeeDataSet}
   ${Facility_BranchCode}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_BranchCode    ${rowid}    ${ComSeeDataSet}
   ${Facility_BranchDescription}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_BranchDescription    ${rowid}    ${ComSeeDataSet}
   ${Facility_FundingDeskCode}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_FundingDeskCode    ${rowid}    ${ComSeeDataSet}
   ${Facility_FundingDeskDescription}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_FundingDeskDescription    ${rowid}    ${ComSeeDataSet}
   ${Facility_ExpiryDate}    Read Data From Excel    ComSee_SC2_FacSetup    Facility_ExpiryDate    ${rowid}    ${ComSeeDataSet}
