...
Navigate Notebook Workflow
    ...
    ...    @update: songchan    29JAN2021    Added condition for warning checking for Rate Setting transaction to click Yes on Warning pop-up
    ...
    Run Keyword If    '${Transaction}'=='Rate Setting'    mx LoanIQ click element if present    ${LIQ_Question_Yes_Button}
