...
LIQ_Logout_OK_Button = 'JavaWindow("title:=.*LoanIQ.*7.*").JavaButton("label:=OK")'  
...
###Warning Window###
LIQ_Warning_Window = 'JavaWindow("title:=Warning.*","displayed:=1")'
LIQ_Warning_Yes_Button = 'JavaWindow("title:=Warning.*", "displayed:=1").JavaButton("label:=Yes")'
...
###Deal/Facility Pricing Notebook - Add Item, Fee Selection, Formula Category windows###
###Add Item Window###
...
LIQ_FormulaCategory_Spread_Textfield = 'JavaWindow("title:=Formula Category").JavaTab("tagname:=X").JavaEdit("tagname:=X")'
...
LIQ_NoticeGroup_Exit_Button = 'JavaWindow("title:=.*Notice Group.*","displayed:=1").JavaButton("label:=Exit")'
...
LIQ_NoticeCreatedBy_File_Exit = 'JavaWindow("title:=.*Notice created by.*","displayed:=1").JavaMenu("label:=File").JavaMenu("label:=Exit")'
