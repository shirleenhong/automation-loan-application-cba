...
LIQ_PricingChangeTransaction_GeneralTab_DealName = 'JavaWindow("title:=Pending Pricing Change Transaction").JavaStaticText("attached text:=${Deal_Name}")'
LIQ_PricingChangeTransaction_GeneralTab_FacilityName = 'JavaWindow("title:=Pending Pricing Change Transaction").JavaStaticText("attached text:=${Facility_Name}")'
