...
LIQ_Notice_NoticeMethod_JavaStaticText = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaStaticText("attached text:=Notice Method:")' 
LIQ_Notice_NoticeID_JavaStaticText = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaStaticText("attached text:=Notice ID:")'
LIQ_Notice_Email_JavaStaticText = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaStaticText("attached text:=E-mail:")'
LIQ_Notice_Language_JavaStaticText = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaStaticText("attached text:=Language:")'
LIQ_Notice_Regarding_JavaStaticText = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaStaticText("attached text:=Regarding:")'
LIQ_Notice_Text_JavaStaticText = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaStaticText("attached text:=Text:")'
LIQ_Notice_Status_JavaStaticText = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaStaticText("attached text:=Status:")'
LIQ_Notice_DateLastSent_JavaStaticText = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaStaticText("label:=Date Last Sent:")'
LIQ_Notice_TimeLastSent_JavaStaticText = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaStaticText("label:=Time Last Sent:")'
LIQ_Notice_LastSentBy_JavaStaticText = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaStaticText("label:=Last Sent By:")'
...
LIQ_NoticeGroup_Refresh_Button = 'JavaWindow("title:=.* Group created by .*","displayed:=1").JavaButton("attached text:=Refresh")'
LIQ_NoticeGroup_Unmarkall_Button = 'JavaWindow("title:=.* Group created by .*","displayed:=1").JavaButton("attached text:=Unmark all")'
