...
LIQ_Loan_RiskType_Text = 'JavaWindow("title:=.*Loan.*Active").JavaStaticText("Index:=2")'
...
LIQ_Loan_EffectiveDate_Text = 'JavaWindow("title:=.*Loan.*Active").JavaStaticText("Index:=4")'
...
LIQ_Loan_PricingOption_Text = 'JavaWindow("title:=.*Loan.*Active").JavaStaticText("Index:=13")'
...
LIQ_Loan_RepricingDate_Text = 'JavaWindow("title:=.*Loan.*Active").JavaStaticText("labeled_containers_path:=Tab:General;", "x:=827", "y:=243")'
