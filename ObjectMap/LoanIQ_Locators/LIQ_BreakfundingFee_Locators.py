...
LIQ_Breakfunding_InquiryMode_Button = 'JavaWindow("title:=Break Cost Fee.*").JavaButton("attached text:=Notebook in Inquiry Mode - F7")'
LIQ_Breakfunding_Pending_Window = 'JavaWindow("title:=Break Cost Fee / Pending.*")'
LIQ_Breakfunding_Workflow_Tab= 'JavaWindow("title:=Break Cost Fee.*","displayed:=1").JavaTab("tagname:=TabFolder")'
LIQ_Breakfunding_AwaitingSend_Tab= 'JavaWindow("title:=Break Cost Fee / Awaiting Send To Approval.*","displayed:=1").JavaTab("tagname:=TabFolder")'
LIQ_Breakfunding_AwaitingSend_Window = 'JavaWindow("title:=Break Cost Fee / Awaiting Send To Approval.*","displayed:=1")'
LIQ_Breakfunding_AwaitingApproval_Window = 'JavaWindow("title:=Break Cost Fee / Awaiting Approval.*","displayed:=1")'
LIQ_Breakfunding_AwaitingApproval_Tab= 'JavaWindow("title:=Break Cost Fee / Awaiting Approval.*","displayed:=1").JavaTab("tagname:=TabFolder")'
LIQ_Breakfunding_AwaitingRelease_Window = 'JavaWindow("title:=Break Cost Fee / Awaiting Release.*","displayed:=1")'
LIQ_Breakfunding_AwaitingRelease_Tab= 'JavaWindow("title:=Break Cost Fee / Awaiting Release.*","displayed:=1").JavaTab("tagname:=TabFolder")'
...
LIQ_Breakfunding_Borrower_Label = 'JavaWindow("title:=Break Cost Fee / Pending.*").JavaStaticText("x:=164","y:=88")'
LIQ_Breakfunding_LoanAlias_Label = 'JavaWindow("title:=Break Cost Fee / Pending.*").JavaStaticText("x:=509","y:=58")'
LIQ_Breakfunding_PricingOption_Label = 'JavaWindow("title:=Break Cost Fee / Pending.*").JavaStaticText("x:=528","y:=89")'
LIQ_Breakfunding_Currency_Label = 'JavaWindow("title:=Break Cost Fee / Pending.*").JavaStaticText("x:=477","y:=122")'

###Breakfunding General tab###
LIQ_Breakfunding_HostBankFees_Text = 'JavaWindow("title:=Break Cost Fee .*").JavaEdit("attached text:=Total Host Bank Fees:")'
LIQ_Breakfunding_BorrowerFees_Text = 'JavaWindow("title:=Break Cost Fee .*").JavaEdit("attached text:=Total Borrower Fees:")'

###Breakfunding Fee - Workflow Tab###
LIQ_Breakfunding_WorkflowItems_List = 'JavaWindow("title:=Break Cost Fee.*").JavaTree("attached text:=Drill down to perform Workflow item")'
LIQ_Breakfunding_WorkflowItems_AwaitingSend_List = 'JavaWindow("title:=Break Cost Fee / Awaiting Send To Approval.*","displayed:=1").JavaTree("attached text:=Drill down to perform Workflow item")'
LIQ_Breakfunding_WorkflowItems_AwaitingApproval_List = 'JavaWindow("title:=Break Cost Fee / Awaiting Approval.*","displayed:=1").JavaTree("attached text:=Drill down to perform Workflow item")'
LIQ_Breakfunding_WorkflowItems_AwaitingRelease_List = 'JavaWindow("title:=Break Cost Fee / Awaiting Release.*","displayed:=1").JavaTree("attached text:=Drill down to perform Workflow item")'
...
LIQ_SharesForBreakCostFee_LegalEntity_List = 'JavaWindow("title:=Shares for .*(AUD.*) Break Cost Fee in Deal.*").JavaTree("attached text:=Drill Down for Portfolio Shares")'
LIQ_SharesForBreakCostFee_Ok_Button = 'JavaWindow("title:=Shares for .*(AUD.*) Break Cost Fee in Deal.*").JavaButton("attached text:=OK")'
...
LIQ_BreakFundingCashflow_Window = 'JavaWindow("title:=Cashflows For Break Cost Fee")'
LIQ_BreakFundingCashflow_Ok_Button = 'JavaWindow("title:=Cashflows For Break Cost Fee").JavaButton("attached text:=OK")'
LIQ_BreakFunding_Cashflows_List = 'JavaWindow("title:=Cashflows For Break Cost Fee").JavaTree("attached text:=Drill down to view/change details")'
LIQ_BreakFunding_Cashflows_DoIt_Button = 'JavaWindow("title:=Cashflows For Break Cost Fee").JavaButton("label:=Set Selected Item To .*")'
LIQ_Breakfunding_Queries_GLEntries_Cashflow = 'JavaWindow("title:=Cashflows For Break Cost Fee").JavaMenu("label:=Queries").JavaMenu("label:=GL Entries")'
LIQ_Breakfunding_Cashflow_HostBankCash_JavaEdit = 'JavaWindow("title:=Cashflows .* Break Cost Fee.*").JavaStaticText("to_class:=JavaStaticText","index:=28")'
