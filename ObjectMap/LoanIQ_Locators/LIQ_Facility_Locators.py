...
LIQ_FacilityPricing_OngoingFeeInterest_Cancel_Button = 'JavaWindow("title:=Facility.*Pricing").JavaButton("attached text:=Cancel")'    
...
LIQ_FacilityPricing_OngoingFeeInterest_OutsideCondition_OK_Button = 'JavaWindow("title:=Outside Condition").JavaButton("attached text:=OK")'
...
LIQ_FacilityChangeTransaction_AmortizationSchedule_Frequency = 'JavaWindow("title:=Amortization Schedule For Facility Change Transaction.*").JavaList("attached text:=Frequency:")'
LIQ_FacilityChangeTransaction_AmortizationSchedule_JavaTree = 'JavaWindow("title:=Amortization Schedule For Facility Change Transaction.*").JavaTree("attached text:=item\(s\) selected\.")'
...
LIQ_FacilityNotebook_Accounting_EnterAsOfAccrualDate_Window = 'JavaWindow("title:=Enter As-Of Accrual Date:")'
LIQ_FacilityNotebook_Accounting_EnterAsOfAccrualDate_AsOfDate_TextField = 'JavaWindow("title:=Enter As-Of Accrual Date:").JavaEdit("attached text:=As-Of Date:")'
LIQ_FacilityNotebook_Accounting_EnterAsOfAccrualDate_OK_Button = 'JavaWindow("title:=Enter As-Of Accrual Date:").JavaButton("attached text:=OK")'
LIQ_FacilityNotebook_Accounting_EnterAsOfAccrualDate_Cancel_Button = 'JavaWindow("title:=Enter As-Of Accrual Date:").JavaButton("attached text:=Cancel")'