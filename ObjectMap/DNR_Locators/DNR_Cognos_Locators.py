...
DNR_PaymentReportFolder_Link_Locator = '//div[@title="${sPayment_Type}" and contains(@role,"link")]'
...
DNR_TeamContent_CBAReports_PaymentMonthYear_Calendar_Locator = '//span[contains(text(),"Enter payment date")]/parent::div/following-sibling::div//table[@specname="selectDate"]//input'
DNR_TeamContent_CBAReports_PaymentMonth_Calendar_Locator = '//span[contains(text(),"Enter payment date")]/parent::div/following-sibling::div//table[@specname="selectDate"]//td[contains(@id,"calMonth") and text()="${sPaymentMonth}"]'
DNR_TeamContent_CBAReports_PaymentDate_Calendar_Locator = '//span[contains(text(),"Enter payment date")]/parent::div/following-sibling::div//table[@specname="selectDate"]//td[contains(@id,"calDay") and text()="${sPaymentDay}"]'
