...
Party_MaintainPartyDetails_PartyAddress_AddressLine1_Textbox = '//input[contains (@id, "partyAddressDetail:addressLine1") and contains (@name, "addressLine1")]'
Party_MaintainPartyDetails_PartyAddress_AddressLine2_Textbox = '//input[contains (@id, "partyAddressDetail:addressLine2") and contains (@name, "addressLine2")]'
Party_MaintainPartyDetails_PartyAddress_AddressLine3_Textbox = '//input[contains (@id, "partyAddressDetail:addressLine3") and contains (@name, "addressLine3")]'
Party_MaintainPartyDetails_PartyAddress_AddressLine4_Textbox = '//input[contains (@id, "partyAddressDetail:addressLine4") and contains (@name, "addressLine4")]'
Party_MaintainPartyDetails_PartyAddress_AddressLine5_Textbox = '//input[contains (@id, "partyAddressDetail:addressLine5") and contains (@name, "addressLine5")]'
