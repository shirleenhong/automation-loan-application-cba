...
Party_QuickEnterpriseParty_GoBack_Button = '//input[contains(@id, "GoBack")]'
Party_QuickEnterpriseParty_Dialog_TextArea = '//form[contains(@id, "EVENT_ERROR")]//textarea[contains(@name, "messages")]'
