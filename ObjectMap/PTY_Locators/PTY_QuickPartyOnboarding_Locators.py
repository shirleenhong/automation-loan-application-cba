...
Party_EnterpriseDetailsSummary_TaxCountry_Cell = '//div[contains(@id,"partyTaxSchemes") and @role="grid"]//div[contains(@class,"GridMasterView")]//table[1]//td[1]'
Party_EnterpriseDetailsSummary_TaxNumber_Cell = '//div[contains(@id,"partyTaxSchemes") and @role="grid"]//div[contains(@class,"GridMasterView")]//table[1]//td[2]'
